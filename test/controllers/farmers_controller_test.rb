...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference("Farmer.count") do
      post farmers_url, params: { farmer: { age: @farmer.age, farm_id: @farmer.farm_id, name: @farmer.name } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { age: @farmer.age, farm_id: @farmer.farm_id, name: @farmer.name } }
